...
<div class="container">
    <div class="container py-5 cardcontent">
        ...
        <div class="row pt-3">
            ...
            @foreach ($get as $data)
                <div class="col-md-12 mt-3 cardadbefore"> <!-- Adjusted column size to col-md-6 -->
                                ...
                                <div class="col-md-4 mt-3">
                                    <div class="card rounded-4 maincardd">
                                        ...
                                        <div class="input-group my-4 rounded-3 inputfeilsset">
                                            <input type="text" class="form-control border-0" readonly placeholder="Nouman Imran" aria-label="Recipient's username" aria-describedby="basic-addon2">
